...
import { WorkerFileUpload } from "@/components/worker-file-upload";
...
export default async function WorkerTaskDetailPage({ params }: Props) {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      {/* Upload deliverables */}
      <WorkerFileUpload taskId={task.id} userId={user.id} />
